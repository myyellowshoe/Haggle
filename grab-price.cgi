...
foreach my $link (@links) {
   ...
   #Removing .. from starting of link url. Its put in there when mech pulls in the links.
   my $urlLink = uri_escape($link->url);
    substr($urlLink, 0, 2) = "";

  $linkRef=$linkRef+1;
   my $theLink = "<br /><a href=\"grab-price.cgi?section=2&trim=".$linkRef."\"id=\"".$urlLink."\">".uri_unescape($link->text)."</a><br />";
